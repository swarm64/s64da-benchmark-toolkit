...
CREATE FOREIGN TABLE part (
    ...
    p_retailprice double precision NULL,
...
CREATE FOREIGN TABLE supplier (
    ...
    s_acctbal double precision NULL,
...
CREATE FOREIGN TABLE partsupp (
    ...
    ps_supplycost double precision NULL,
...
CREATE FOREIGN TABLE customer (
    ...
    c_acctbal double precision NULL,
...
CREATE FOREIGN TABLE lineitem (
    ...
    l_extendedprice double precision NULL,
    l_discount double precision NULL,
    l_tax double precision NULL,
