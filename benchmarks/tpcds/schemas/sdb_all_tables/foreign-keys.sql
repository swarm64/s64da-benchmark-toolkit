...
ALTER FOREIGN TABLE household_demographics OPTIONS (ADD foreign_keys_hint
    'foreign key (hd_income_band_sk)        references income_band (ib_income_band_sk)'
);

ALTER FOREIGN TABLE promotion OPTIONS (ADD foreign_keys_hint
...
ALTER FOREIGN TABLE store OPTIONS (ADD foreign_keys_hint
    'foreign key (s_closed_date_sk)         references date_dim (d_date_sk)'
);

ALTER FOREIGN TABLE web_page OPTIONS (ADD foreign_keys_hint
...
ALTER FOREIGN TABLE web_site OPTIONS (ADD foreign_keys_hint
    'foreign key (web_open_date_sk)         references date_dim (d_date_sk),
    foreign key (web_close_date_sk)         references date_dim (d_date_sk)'
);

ALTER FOREIGN TABLE catalog_returns OPTIONS (ADD foreign_keys_hint
...
ALTER FOREIGN TABLE catalog_sales OPTIONS(ADD foreign_keys_hint
...
ALTER FOREIGN TABLE inventory OPTIONS(ADD foreign_keys_hint
...
ALTER FOREIGN TABLE store_returns OPTIONS(ADD foreign_keys_hint
...
ALTER FOREIGN TABLE store_sales OPTIONS(ADD foreign_keys_hint
...
ALTER FOREIGN TABLE web_returns OPTIONS(ADD foreign_keys_hint
...
ALTER FOREIGN TABLE web_sales OPTIONS(ADD foreign_keys_hint
