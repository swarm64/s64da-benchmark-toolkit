...
def add_parser(subparsers):
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help=("The number of OLAP workers running TPC-H-like queries, default: 1."),
    )
    ...
    parser.add_argument(
        ...
        default=None,
        type=int,
        help=("The target TPS for the otlp queries, default: unlimited."),
    )
    ...
    parser.add_argument(
        ...
        default=60,
        type=int,
        help=("How many seconds the benchmark should run for, default: 60."),
    )
    ...
    parser.add_argument(
        ...
        default=900,
        type=int,
        help=("Timeout for OLAP queries in seconds, default: 900"),
    )
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help=("How often to report stats to the csv files in seconds, default: 10"),
    )
    ...
    parser.add_argument(
        "--stats-dsn",
        help=(
            "The DSN to use for collecting statistics into a database. "
    ...
    parser.add_argument(
        ...
        action="store_true",
        required=False,
        help=("Use server-side cursors for executing the queries"),
    )
